    ...
    public sealed class PlayerInput : NetworkBehaviour, IBeforeUpdate
    {
        ...
        void IBeforeUpdate.BeforeUpdate()
        {
            ...
            if (mouse != null)
            {
                ...
                _accumulatedInput.Buttons.Set(EInputButton.Draw, mouse.leftButton.isPressed);
                _accumulatedInput.Buttons.Set(EInputButton.Shoot, mouse.leftButton.wasReleasedThisFrame);
            }
